      ...
      <Responsive getWidth={getWidth} minWidth={Responsive.onlyTablet.minWidth}>
        ...
        >
          <Segment
            inverted
            textAlign='center'
            style={{ minHeight: 700, padding: '1em 0em', backgroundColor: '#fff' }}
            vertical
          >
            <Menu
              display='flex'
      ...
      >
        ...
        <Sidebar.Pusher dimmed={sidebarOpened}>
          <Segment
            // inverted
            textAlign='center'
            style={{ minHeight: 350, padding: '1em 0em', backgroundColor: '#fff' }}
            vertical
          >
            <Container>
              <Menu inverted pointing secondary size='large' style={{ backgroundColor: '#004D8A' }}>
